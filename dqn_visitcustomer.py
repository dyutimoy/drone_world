...
MAX_EXPERIENCES =1000 #500000
MIN_EXPERIENCES =100 #50000
TARGET_UPDATE_PERIOD =10 #10000
IM_SIZE = 10
...
def downsample_image(A):
  ...
  B = A.mean(axis=2) # convert to grayscale
...
if __name__ == '__main__':
  ...
  num_episodes = 20
  total_t = 0
  rewards_plot= np.zeros(num_episodes)
  experience_replay_buffer = []
